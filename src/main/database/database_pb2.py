...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='database/database.proto',
  package='org.querc.cb_grpc.msg.Database',
  syntax='proto3',
  serialized_options=_b('\n\025org.querc.cb_grpc.msgB\010Database'),
  serialized_pb=_b('\n\x17\x64\x61tabase/database.proto\x12\x1eorg.querc.cb_grpc.msg.Database\"\x0b\n\tConnected\")\n\x06TxnLog\x12\x0e\n\x06\x64oc_id\x18\x01 \x01(\t\x12\x0f\n\x07\x63hanges\x18\x02 \x03(\tB!\n\x15org.querc.cb_grpc.msgB\x08\x44\x61tabaseb\x06proto3')
)
...
Connected = _reflection.GeneratedProtocolMessageType('Connected', (_message.Message,), dict(
  ...
  __module__ = 'database.database_pb2'
